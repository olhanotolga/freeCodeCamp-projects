...
const outputDisplay = document.getElementById("converted-numeral");

const convertToRoman = num => {
  num = Number(num);
  // define the exceptions:
  if (typeof num !== 'number' || !Number.isInteger(num)) {
    return exceptionDisplay.innerHTML = "<p>Please type a proper whole number</p>";
  }
  if (num < 1 || num > 3999) {
    return exceptionDisplay.innerHTML = "<p>Your number is outside of the classic Roman numerals' range (1 to 3999)</p>";
  }
  ...
  outputDisplay.textContent = romanNum;
